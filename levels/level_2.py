...
def level_2():
    ...
    #Enemy
    m_attack1 = [
        pygame.image.load("images/2 Battle turtle/attack_1/Battle_turtle_attack1.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_1/Battle_turtle_attack1 (1).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_1/Battle_turtle_attack1 (2).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_1/Battle_turtle_attack1 (3).png").convert_alpha(),
    ]
    m_attack2 = [
        pygame.image.load("images/2 Battle turtle/attack_2/Battle_turtle_attack2.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_2/Battle_turtle_attack2 (1).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_2/Battle_turtle_attack2 (2).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_2/Battle_turtle_attack2 (3).png").convert_alpha(),
    ]
    m_attack3 = [
        pygame.image.load("images/2 Battle turtle/attack_3/Battle_turtle_attack3.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_3/Battle_turtle_attack3 (1).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_3/Battle_turtle_attack3 (2).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_3/Battle_turtle_attack3 (3).png").convert_alpha(),
    ]
    m_attack4 = [
        pygame.image.load("images/2 Battle turtle/attack_4/Battle_turtle_attack4.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_4/Battle_turtle_attack4 (1).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_4/Battle_turtle_attack4 (2).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/attack_4/Battle_turtle_attack4 (3).png").convert_alpha(),
    ]
    m_bullet = [
        pygame.image.load("images/2 Battle turtle/bullet/Bullet1.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/bullet/Bullet2.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/bullet/Bullet3.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/bullet/Bullet4.png").convert_alpha(),
    ]
    m_death = [
        pygame.image.load("images/2 Battle turtle/death/Battle_turtle_death.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/death/Battle_turtle_death (1).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/death/Battle_turtle_death (2).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/death/Battle_turtle_death (3).png").convert_alpha(),
    ]
    m_hurt = [
        pygame.image.load("images/2 Battle turtle/hurt/Battle_turtle_hurt.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/hurt/Battle_turtle_hurt (1).png").convert_alpha(),
    ]
    m_idle = [
        pygame.image.load("images/2 Battle turtle/idle/Battle_turtle_idle.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/idle/Battle_turtle_idle (1).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/idle/Battle_turtle_idle (2).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/idle/Battle_turtle_idle (3).png").convert_alpha(),
    ]
    m_sneer = [
        pygame.image.load("images/2 Battle turtle/sneer/Battle_turtle_sneer.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/sneer/Battle_turtle_sneer (1).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/sneer/Battle_turtle_sneer (2).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/sneer/Battle_turtle_sneer (3).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/sneer/Battle_turtle_sneer (4).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/sneer/Battle_turtle_sneer (5).png").convert_alpha(),
    ]
    m_walk = [
        pygame.image.load("images/2 Battle turtle/walk/Battle_turtle_walk.png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/walk/Battle_turtle_walk (1).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/walk/Battle_turtle_walk (2).png").convert_alpha(),
        pygame.image.load("images/2 Battle turtle/walk/Battle_turtle_walk (3).png").convert_alpha(),
    ]
    monster_x = 584
    monster_y = 660
    monster_health = 4
    ...
    while running:
        ...
        if gameplay:
            ...
            monster_rect = m_idle[0].get_rect(topleft=(monster_x + 10, monster_y))
            ...
            screen.blit(m_idle[player_anim_count % 4], (monster_x, monster_y))
