from main_screen import pygame, draw_text, main_font, main_menu, font, sys
...
def level_3():
    ...
    def pause_screen(paused):
        while paused:
            draw_text("Pause", main_font, "black", screen, 1550 // 2, 840 // 4)

            mx, my = pygame.mouse.get_pos()

            button_1 = pygame.Rect(1550 // 2 - 100, 840 // 2 - 50, 200, 50)
            pygame.draw.rect(screen, "black", button_1)
            draw_text("Resume", font, "white", screen, 1550 // 2, 840 // 2 - 25)
    ...
    #Enemy
    monster = pygame.image.load("../images/woodcutter/Woodcutter.png").convert_alpha()
    monster_x = 584
    monster_y = 700
    ...
    label = pygame.font.Font('../fonts/Micro5-Regular.ttf', 100)
    lose_label = label.render("You lost!", True, "white")
    restart_label = label.render("Restart", True, "white")
    restart_label_rect = restart_label.get_rect(topleft=(670, 425))
